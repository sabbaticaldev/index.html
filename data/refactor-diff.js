export default {
  ...
  refactoringFiles: "uix/form components refactored",
  taskPrompt: `
  ...
  We need to refactor the uix components to have a tag property with its tag (example: uix-input, uix-button)
