...
export default {
  ...
  refactoringFiles: "uix/content, crud frontend files affected by the change",
  taskPrompt: `  
    ...
    lets refactor the usage of class={$this.theme("uix-class")} with data-theme="uix-class"
