export default {
  ...
  refactoringFiles:
    "all files related to adding missing components to libs/frontend/uix/chat, crud, datetime, docs",
  ...
  you can also improve, refactor and implement new important missing features in the existing components
  `,
  responseFormat: "xml",
};
