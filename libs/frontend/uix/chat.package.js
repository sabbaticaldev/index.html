    ...
    return html`
      <uix-list>
        ...
        <uix-list vertical containerClass=${this.generateTheme("uix-chat-message")} spacing="md">
          ...
          <uix-time class="text-xs opacity-50 text-right" timestamp=${timestamp}></uix-time>
        </uix-list>
      </uix-list>
    `;
  },
        ...
        <uix-block spacing="sm">
          <uix-list>
            ...
            <uix-list vertical justify="center" class="flex-grow">
              <uix-text size="sm" weight="bold" class="tracking-wide text-gray-700">${sender}</uix-text>
              <uix-text weight="medium" size="xs" font="mono" containerClass="text-gray-400 text-ellipsis text-xs overflow-hidden whitespace-nowrap w-36">
                ${message}
              </uix-text>
            </uix-list>
            <uix-list vertical justify="evenly" containerClass="text-right">
              <uix-time class="text-xs opacity-50" timestamp=${timestamp}></uix-time>
