...
const Tooltip = {
  ...
  _theme: {
    ".uix-tooltip__container": "relative inline-block [&_[content]]:hover:block",
    ...
    ${genTheme('variant', Object.keys(TooltipVariants), (entry) => TooltipVariants[entry], { string: true })}`,
  ...
  render() {
    return html`
      <div class="uix-tooltip__container" variant=${this.variant} position=${this.position}>
        <slot name="cta"></slot>
